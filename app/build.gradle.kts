...
android {
    namespace = "com.morseverse.app"
    compileSdk = 35

    defaultConfig {
        applicationId = "com.morseverse.app"
        minSdk = 26
        targetSdk = 35
        versionCode = 1
        versionName = "1.0.0"
    ...
    signingConfigs {
        create("release") {
            ...
            keyAlias = System.getenv("KEY_ALIAS") ?: "morseverse"
...
dependencies {
    ...
    implementation(project(":feature:morseTree"))
    ...
    implementation(project(":feature:ham"))
